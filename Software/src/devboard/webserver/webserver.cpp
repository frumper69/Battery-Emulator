...
// Show hardware used:
    ...
    if (!contactor_control_enabled && !datalayer.system.status.battery_reports_contactor_state) {
      ...
      content += "</div>";
    } else {  //contactor_control_enabled TRUE, or a battery is self-reporting its own contactor state via CAN
